...
public class NameValidator{
	public boolean nameValidator(String filename, String filetype){
		...
		PropertyConfigurator.configure("C:\\Users\\Mahip Gupta\\Desktop\\csvtojson\\configs\\logger\\logger.properties");
		try{	
			input = new FileInputStream("C:\\Users\\Mahip Gupta\\Desktop\\csvtojson\\configs\\constants\\exceptions.properties");
			prop.load(input);
